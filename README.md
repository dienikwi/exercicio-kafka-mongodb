# Exercício | criação de pedidos

Projeto back-end construído com SpringBoot para exercitar Kafka e manipulação do MongoDB.<br>A aplicação efetua o cadastro de usuários, produtos e pedidos.
